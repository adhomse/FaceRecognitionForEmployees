...
video_capture = cv2.VideoCapture('E:/clients/Face_Detection_&_RecognitionV2/client-side-partV2/Client-V2/output.avi')
video_capture.set(3, IMAGE_WIDTH)
video_capture.set(4, IMAGE_HEIGHT)
img_counter = 0
...
# When everything is done, release the csapture
